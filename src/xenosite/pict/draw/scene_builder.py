...
from xenosite.pict.draw.drawn import halo_prims
from xenosite.pict.draw.glyphs import compile_text_shapes
from xenosite.pict.draw.halo import circle_ring_shape, disk_shape
from xenosite.pict.draw.metrics import HALO_STROKE, LABEL_GAP_PX, STROKE_PX
from xenosite.pict.draw.mol_title import pack_label
from xenosite.pict.draw.paths import ink_from_path_prim
