 ...
 * rings (SP3) do not match quinones (SP2). ``BondRingMatchesRingOnly`` keeps
 * ring *bonds* from matching chain bonds (ring atoms may still match).
 ...
 * ``BondRingMatchesRingOnly`` alone (not top-level ``RingMatchesRingOnly``).
 */
