 ...
 */
export function kabsch2d(src: Float64Array, dst: Float64Array, allow_reflect: boolean): Float64Array;
 ...
 */
export function rigidAlignCoords(template: Float64Array, other: Float64Array, mapping: Int32Array): Float64Array;
...
export interface InitOutput {
    ...
    readonly atomicNumber: (a: number, b: number) => number;
    ...
    readonly elementSymbol: (a: number) => [number, number];
    readonly kabsch2d: (a: number, b: number, c: number, d: number, e: number) => [number, number, number, number];
    ...
    readonly rigidAlignCoords: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number, number];
